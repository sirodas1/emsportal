                ...
                <form action="{{route('account.update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col">
                                <input id="pharmacist_card_number" type="text" class="form-control @error('pharmacist_card_number') is-invalid @enderror" name="pharmacist_card_number" value="{{ auth()->user()->pharmacist_card_number }}" required autocomplete="pharmacist_card_number" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col">
                                <input id="othernames" type="text" class="form-control @error('othernames') is-invalid @enderror" name="othernames" value="{{ auth()->user()->othernames }}" required autocomplete="othernames" autofocus>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="col">
                                <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ auth()->user()->age }}" required autocomplete="age" autofocus>
